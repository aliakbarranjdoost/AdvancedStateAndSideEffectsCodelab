...
import androidx.compose.samples.crane.base.rememberCraneEditableUserInputState
...
fun ToDestinationUserInput(onToDestinationChanged: (String) -> Unit) {
    val editableUserInputState = rememberCraneEditableUserInputState(hint = "Chose Destination")
    ...
    val currentDestinationChanged by rememberUpdatedState(onToDestinationChanged)
    LaunchedEffect(editableUserInputState) {
        snapshotFlow { editableUserInputState.text }
            .filter { !editableUserInputState.isHint }
            .collect { currentDestinationChanged(editableUserInputState.text)}
    }
}
